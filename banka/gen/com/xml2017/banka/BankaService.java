...
public class BankaService extends Service {
    ...
    public final static QName BankaPort = new QName("http://www.xml2017.com/banka", "BankaPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Git/XML-WS/banka/WEB-INF/wsdl/Bank.wsdl");
     ...
     *
     * @return
     *     returns BankaPortType
     */
    @WebEndpoint(name = "BankaPort")
    public BankaPortType getBankaPort() {
        return super.getPort(BankaPort, BankaPortType.class);
    }
     ...
     */
    @WebEndpoint(name = "BankaPort")
    public BankaPortType getBankaPort(WebServiceFeature... features) {
        return super.getPort(BankaPort, BankaPortType.class, features);
    }
